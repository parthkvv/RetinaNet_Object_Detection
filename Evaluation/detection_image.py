...
# image_path = r"E:\IDD_Detection\test_data\test_image\0_007325_leftImg8bit.jpeg"
...
def detection_on_image(image_path):
        ...
        for box, score, label in zip(boxes[0], scores[0], labels[0]):
            ...
            # print(labels_to_names[label],box.astype(int),score)
            csv_line = [cnt, box.astype(int), labels_to_names[label], score]

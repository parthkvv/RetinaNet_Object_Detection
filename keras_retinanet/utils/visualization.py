...
def draw_box(image, box, color, thickness=2):
    ...
    cv2.rectangle(np.array(image), (b[0], b[1]), (b[2], b[3]), color, thickness, cv2.LINE_AA)
...
def draw_caption(image, box, caption):
    ...
    """
    b = np.array(box).astype(int)
    cv2.putText(np.array(image), caption, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 0), 2)
    cv2.putText(np.array(image), caption, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255), 1)
